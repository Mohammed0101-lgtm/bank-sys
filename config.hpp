...
static inline const std::string base64_chars = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"
...
inline nlohmann::json get_jsonData(const std::string& filename) {
    nlohmann::json data;
    ...
    try
    { inFile >> data; } catch (const nlohmann::json::parse_error& e)
    {
