...
std::string get_time() {
    ...
    else if (tokens[1] == "Feb")
    {
        date_tokens[1] = "02";
    }
    else if (tokens[1] == "Mar")
    {
        date_tokens[1] = "03";
    }
    else if (tokens[1] == "Apr")
    {
        date_tokens[1] = "04";
    }
    else if (tokens[1] == "May")
    {
        date_tokens[1] = "05";
    }
    else if (tokens[1] == "Jun")
    {
        date_tokens[1] = "06";
    }
    else if (tokens[1] == "Jul")
    {
        date_tokens[1] = "07";
    }
    else if (tokens[1] == "Aug")
    {
        date_tokens[1] = "08";
    }
    else if (tokens[1] == "Sep")
    {
        date_tokens[1] = "09";
    }
    else if (tokens[1] == "Oct")
    {
        date_tokens[1] = "10";
    }
    else if (tokens[1] == "Nov")
    {
        date_tokens[1] = "11";
    }
...
int make_transaction(const std::string& from,
                     const std::string& to,
                     unsigned int       amount,
